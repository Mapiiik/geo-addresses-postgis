...
INSERT INTO cz_addresses (
    kod_adm, obec_nazev, mop_nazev, cast_obce_nazev, ulice_nazev, typ_so,
...
(25510878, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', 'Věnceslava Metelky', 'č.p.', 367, NULL, NULL, 51211,
 ST_SetSRID(ST_MakePoint(15.39923, 50.68743), 4326), 'Věnceslava Metelky 367, 51211 Vysoké nad Jizerou'),
(16958608, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', 'Bozkovská', 'č.p.', 116, NULL, NULL, 51211,
 ST_SetSRID(ST_MakePoint(15.40031, 50.68586), 4326), 'Bozkovská 116, 51211 Vysoké nad Jizerou'),
(16958977, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', 'Bozkovská', 'č.p.', 153, NULL, NULL, 51211,
...
(16957814, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', NULL, 'č.p.', 36, NULL, NULL, 51211,
 ST_SetSRID(ST_MakePoint(15.40369, 50.68707), 4326), 'č.p. 36, 51211 Vysoké nad Jizerou'),
(25418327, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', NULL, 'č.p.', 363, NULL, NULL, 51211,
 ST_SetSRID(ST_MakePoint(15.39569, 50.68890), 4326), 'č.p. 363, 51211 Vysoké nad Jizerou'),
(25418297, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', NULL, 'č.p.', 365, NULL, NULL, 51211,
 ST_SetSRID(ST_MakePoint(15.40513, 50.68818), 4326), 'č.p. 365, 51211 Vysoké nad Jizerou'),
(25418271, 'Vysoké nad Jizerou', NULL, 'Vysoké nad Jizerou', NULL, 'č.p.', 369, NULL, NULL, 51211,
...
(21715955, 'Praha', 'Praha 1', 'Staré Město', 'Karlova', 'č.p.', 144, 27, NULL, 11000,
 ST_SetSRID(ST_MakePoint(14.41910, 50.08644), 4326), 'Karlova 144/27, Staré Město, 11000 Praha 1'),
(21942854, 'Praha', 'Praha 4', 'Nusle', 'Křesomyslova', 'č.p.', 248, 5, NULL, 14000,
...
(11855321, 'Aš', NULL, 'Aš', 'Karlova', 'č.p.', 248, 19, NULL, 35201,
 ST_SetSRID(ST_MakePoint(12.18808, 50.22179), 4326), 'Karlova 248/19, 35201 Aš'),
(11869861, 'Aš', NULL, 'Aš', 'Karlova', 'č.p.', 2480, NULL, NULL, 35201,
...
(16901509, 'Jablonec nad Jizerou', NULL, 'Buřany', NULL, 'č.p.', 33, NULL, NULL, 51243,
